...
const Sidebar = () => {
  ...
  return (
    <div className={`h-full p-3 overflow-y-scroll text-white ${selectedUser ? "max-md:hidden" : ''}`}>
      <div className='pb-5'>
        <div className='flex justify-between items-center'>
          <img src={assets.logo} alt="logo" className='max-w-13' />
        ...
        <div className='bg-[#282142] rounded-xl flex items-center gap-2 py-3 px-4 mt-5'>
